class ImprovedRadarObject extends RadarObject
{
  ...
  ImprovedRadarObject(int min_detectable_distance, int max_detectable_distance, int distance_threshold, int max_width, int max_height, int center_x, int center_y, float min_angle, float max_angle, float step_angle) throws Exception
  {
